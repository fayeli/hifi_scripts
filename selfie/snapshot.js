...
//
// Modified by Faye Li on 16 November 2016 to support selfie snapshot
...
// Faye's addition for selfie support BEGINS
var myChannel = "Selfie-to-Snapshot-Channel";
var handleMessages = function(channel, message, sender) {
    if (channel === myChannel) {
        print("recieved message from selfie");
        onClicked(); // fake a snapshot button click on the hud bar
    }
};
Messages.subscribe(myChannel);
Messages.messageReceived.connect(handleMessages);
// Faye's addition for selfie support ENDS
